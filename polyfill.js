...
window.WebComponents = window.WebComponents || {}, function (e) {
    ...
    function s(e) {
        var t = e.__proto__ || Object.getPrototypeOf(e);
        if (q)try {
            W(t)
        } catch (n) {
            t = t.__proto__
    ...
    function w(t, n, r) {
        for (var o = W(t), i = 0; i < o.length; i++) {
            ...
            if ("polymerBlackList_" !== a && !(a in n || t.polymerBlackList_ && t.polymerBlackList_[a])) {
                q && t.__lookupGetter__(a);
                var s, c, l = m(t, a);
                if (r && "function" == typeof l.value)n[a] = f(a); else {
                    var d = u(a);
                    s = d ? e.getEventHandlerGetter(a) : p(a), (l.writable || l.set || V) && (c = d ? e.getEventHandlerSetter(a) : h(a));
                    var w = V || l.configurable;
                    A(n, a, {get: s, set: c, configurable: w, enumerable: l.enumerable})
                }
            }
        }
    }
    ...
    function T(e) {
        return null === e ? null : (n(S(e)), e.__wrapper8e3dd93a60__ || (e.__wrapper8e3dd93a60__ = new (s(e))(e)))
    }
    ...
    n.prototype = {
        calcEditDistances: function (e, t, n, r, o, i) {
            for (var a = i - o + 1, s = n - t + 1, c = new Array(a), l = 0; a > l; l++)c[l] = new Array(s), c[l][0] = l;
    ...
    function s(e) {
        if (this.childList = !!e.childList, this.subtree = !!e.subtree, this.attributes = "attributes"in e || !("attributeOldValue"in e || "attributeFilter"in e) ? !!e.attributes : !0, this.characterData = "characterDataOldValue"in e && !("characterData"in e) ? !0 : !!e.characterData, !this.attributes && (e.attributeOldValue || "attributeFilter"in e) || !this.characterData && e.characterDataOldValue)throw new TypeError;
    ...
    function p(e) {
        if (!X.get(e) && (X.set(e, !0), f(V(e), V(e.target)), P)) {
            var t = P;
            throw P = null, t
        }
    }
    ...
    function f(t, n) {
        ...
        return nt.set(t, o), m(t, o, a, i) && w(t, o, a, i) && v(t, o, a, i), Z.set(t, rt), $["delete"](t, null), K["delete"](t), t.defaultPrevented
    }
    ...
    function g(e, t, n, r, o) {
        ...
        for (var m = 0, w = i.length; w > m; m++) {
            var v = i[m];
            if (v.removed)f = !0; else if (!(v.type !== h || !v.capture && n === ot || v.capture && n === at))try {
                if ("function" == typeof v.handler ? v.handler.call(e, t) : v.handler.handleEvent(t), et.get(t))return !1
            } catch (g) {
                P || (P = g)
            }
        }
    ...
    function y(e, t) {
        if (!(e instanceof st))return V(T(st, "Event", e, t));
        var n = e;
        return gt || "beforeunload" !== n.type || this instanceof M ? void U(n, this) : new M(n)
    }
    ...
    function T(e, t, n, r) {
        ...
        var o = B(document.createEvent(t)), i = mt[t], a = [n];
    ...
    var P, k = e.forwardMethodsToWrapper, A = e.getTreeScope, W = e.mixin, F = e.registerWrapper, U = e.setWrapper, q = e.unsafeUnwrap, B = e.unwrap, V = e.wrap, G = e.wrappers, z = (new WeakMap, new WeakMap), X = new WeakMap, K = new WeakMap, Y = new WeakMap, $ = new WeakMap, J = new WeakMap, Z = new WeakMap, Q = new WeakMap, et = new WeakMap, tt = new WeakMap, nt = new WeakMap, rt = 0, ot = 1, it = 2, at = 3;
    b.prototype = {
        equals: function (e) {
    ...
    var st = window.Event;
    st.prototype.polymerBlackList_ = {returnValue: !0, keyLocation: !0}, y.prototype = {
        get target() {
            return Y.get(this)
        }, get currentTarget() {
            return $.get(this)
    ...
    var ct = _("UIEvent", y), lt = _("CustomEvent", y), ut = {
        get relatedTarget() {
            var e = J.get(this);
            return void 0 !== e ? e : V(B(this).relatedTarget)
        }
    }, dt = W({initMouseEvent: S("initMouseEvent", 14)}, ut), pt = W({initFocusEvent: S("initFocusEvent", 5)}, ut), ht = _("MouseEvent", ct, dt), ft = _("FocusEvent", ct, pt), mt = Object.create(null), wt = function () {
        try {
    ...
    if (!wt) {
        ...
        vt("Event", {
            bubbles: !1,
            cancelable: !1
        }), vt("CustomEvent", {detail: null}, "Event"), vt("UIEvent", {
            view: null,
            detail: 0
        }, "Event"), vt("MouseEvent", {
            screenX: 0,
            ...
            button: 0,
            relatedTarget: null
        }, "UIEvent"), vt("FocusEvent", {relatedTarget: null}, "UIEvent")
    }
    ...
    e.elementFromPoint = x, e.getEventHandlerGetter = R, e.getEventHandlerSetter = I, e.wrapEventTargetMethods = H, e.wrappers.BeforeUnloadEvent = M, e.wrappers.CustomEvent = lt, e.wrappers.Event = y, e.wrappers.EventTarget = N, e.wrappers.FocusEvent = ft, e.wrappers.MouseEvent = ht, e.wrappers.UIEvent = ct
}(window.ShadowDOMPolyfill), function (e) {
    "use strict";
    function t(e, t) {
    ...
    function m(e, t) {
        ...
        var n = t.length;
        if (1 === n)return P(t[0]);
        for (var r = P(e.ownerDocument.createDocumentFragment()), o = 0; n > o; o++)r.appendChild(P(t[o]));
        return r
    }
    ...
    function v(e) {
        ...
        } else for (var n, i = P(e), a = i.firstChild; a;)n = a.nextSibling, Y.call(i, a), a = n
    }
    ...
    _.prototype = Object.create(S.prototype), D(_.prototype, {
        appendChild: function (e) {
            ...
            if (o = c ? a(e) : i(e, this, s, n), c)h(this, e), w(this), K.call(I(this), P(e), r); else {
                ...
                l ? K.call(l, m(this, o), r) : f(this, o)
            }
            ...
            if (this.invalidateShadowRenderer()) {
                ...
                u && Z(u, i), c === e && (this.firstChild_ = a), l === e && (this.lastChild_ = s), s && (s.nextSibling_ = a), a && (a.previousSibling_ = s), e.previousSibling_ = e.nextSibling_ = e.parentNode_ = void 0
            } else w(this), Z(I(this), i);
            ...
            return p ? s = a(e) : (c === e && (c = e.nextSibling), s = i(e, this, l, c)), p ? (h(this, e), w(this), $.call(I(this), P(e), o)) : (this.firstChild === r && (this.firstChild_ = s[0]), this.lastChild === r && (this.lastChild_ = s[s.length - 1]), r.previousSibling_ = r.nextSibling_ = r.parentNode_ = void 0, o.parentNode && $.call(o.parentNode, m(this, s), o)), N(this, "childList", {
                addedNodes: s,
                removedNodes: n(r),
                nextSibling: c,
                previousSibling: l
    ...
    }), L(_, "ownerDocument"), x(V, _, document.createDocumentFragment()), delete _.prototype.querySelector, delete _.prototype.querySelectorAll, _.prototype = D(Object.create(S.prototype), _.prototype), e.cloneNode = y, e.nodeWasAdded = l, e.nodeWasRemoved = d, e.nodesWereAdded = u, e.nodesWereRemoved = p, e.originalInsertBefore = K, e.originalRemoveChild = Y, e.snapshotNodeList = c, e.wrappers.Node = _
}(window.ShadowDOMPolyfill), function (e) {
    "use strict";
    function t(t, n, r, o) {
        for (var i = null, a = null, s = 0, c = t.length; c > s; s++)i = b(t[s]), !o && (a = v(i).root) && a instanceof e.wrappers.ShadowRoot || (r[n++] = i);
        return n
    }
    ...
    function a(e) {
        e instanceof M.HTMLTemplateElement && (e = e.content);
    ...
    function s(e, t, n) {
        var r = n || "div";
        e.textContent = "";
        var o = S(e.ownerDocument.createElement(r));
        o.innerHTML = t;
        for (var i; i = o.firstChild;)e.appendChild(T(i))
    }
    ...
    function l(e, t) {
        var n = S(e.cloneNode(!1));
        n.innerHTML = t;
        for (var r, o = S(document.createDocumentFragment()); r = n.firstChild;)o.appendChild(r);
        return T(o)
    }

    function u(t) {
        return function () {
            return e.renderAllPending(), _(this)[t]
        }
    }
    ...
    function p(t) {
        Object.defineProperty(c.prototype, t, {
            get: u(t), set: function (n) {
                e.renderAllPending(), _(this)[t] = n
            }, configurable: !0, enumerable: !0
        })
    }
    ...
    function h(t) {
        Object.defineProperty(c.prototype, t, {
            value: function () {
                return e.renderAllPending(), _(this)[t].apply(_(this), arguments)
            }, configurable: !0, enumerable: !0
        })
    }

    var f = e.wrappers.Element, m = e.defineGetter, w = e.enqueueMutation, v = e.mixin, g = e.nodesWereAdded, b = e.nodesWereRemoved, y = e.registerWrapper, E = e.snapshotNodeList, _ = e.unsafeUnwrap, S = e.unwrap, T = e.wrap, M = e.wrappers, O = /[&\u00A0"]/g, L = /[&\u00A0<>]/g, N = o(["area", "base", "br", "col", "command", "embed", "hr", "img", "input", "keygen", "link", "meta", "param", "source", "track", "wbr"]), C = o(["style", "script", "xmp", "iframe", "noembed", "noframes", "plaintext", "noscript"]), j = /MSIE/.test(navigator.userAgent), D = window.HTMLElement, H = window.HTMLTemplateElement;
    c.prototype = Object.create(f.prototype), v(c.prototype, {
        get innerHTML() {
            return a(this)
        }, set innerHTML(e) {
            if (j && C[this.localName])return void(this.textContent = e);
            var t = E(this.childNodes);
            this.invalidateShadowRenderer() ? this instanceof M.HTMLTemplateElement ? s(this.content, e) : s(this, e, this.tagName) : !H && this instanceof M.HTMLTemplateElement ? s(this.content, e) : _(this).innerHTML = e;
            var n = E(this.childNodes);
            w(this, "childList", {addedNodes: n, removedNodes: t}), b(t), g(n, this)
        }, get outerHTML() {
    ...
    "use strict";
    var t = e.wrappers.Element, n = e.wrappers.HTMLElement, r = e.registerObject, o = e.defineWrapGetter, i = "http://www.w3.org/2000/svg", a = document.createElementNS(i, "title"), s = r(a), c = Object.getPrototypeOf(s.prototype).constructor;
    if (!("classList"in a)) {
        var l = Object.getOwnPropertyDescriptor(t.prototype, "classList");
        Object.defineProperty(n.prototype, "classList", l), delete t.prototype.classList
    }
    o(c, "ownerSVGElement"), e.wrappers.SVGElement = c
}(window.ShadowDOMPolyfill), function (e) {
    "use strict";
    function t(e) {
        p.call(this, e)
    ...
    if (c) {
        ...
        var l = /WebKit/.test(navigator.userAgent) ? {drawingBufferHeight: null, drawingBufferWidth: null} : {};
    ...
    function t(e) {
        ...
        var o = e.shadowRoot;
        h.set(this, o), this.treeScope_ = new r(this, a(o || e)), p.set(this, e)
    }

    var n = e.wrappers.DocumentFragment, r = e.TreeScope, o = e.elementFromPoint, i = e.getInnerHTML, a = e.getTreeScope, s = e.mixin, c = e.rewrap, l = e.setInnerHTML, u = e.unsafeUnwrap, d = e.unwrap, p = new WeakMap, h = new WeakMap, f = /[ \t\n\r\f]/;
    t.prototype = Object.create(n.prototype), s(t.prototype, {
        constructor: t, get innerHTML() {
            ...
            return f.test(e) ? null : this.querySelector('[id="' + e + '"]')
        }
    ...
    function r(e, t) {
        D.call(O(t), L(e)), o(e, t)
    }

    function o(e, t) {
        e.shadowRoot && t.adoptNode(e.shadowRoot), e instanceof f && i(e, t);
    ...
    var l = e.GetElementsByInterface, u = e.wrappers.Node, d = e.ParentNodeInterface, p = e.wrappers.Selection, h = e.SelectorsInterface, f = e.wrappers.ShadowRoot, m = e.TreeScope, w = e.cloneNode, v = e.defineWrapGetter, g = e.elementFromPoint, b = e.forwardMethodsToWrapper, y = e.matchesNames, E = e.mixin, _ = e.registerWrapper, S = e.renderAllPending, T = e.rewrap, M = e.setWrapper, O = e.unsafeUnwrap, L = e.unwrap, N = e.wrap, C = e.wrapEventTargetMethods, j = (e.wrapNodeList, new WeakMap);
    t.prototype = Object.create(u.prototype), v(t, "documentElement"), v(t, "body"), v(t, "head"), ["createComment", "createDocumentFragment", "createElement", "createElementNS", "createEvent", "createEventNS", "createRange", "createTextNode", "getElementById"].forEach(n);
    var D = document.adoptNode, H = document.getSelection;
    E(t.prototype, {
    ...
    if (t.prototype.createTreeWalker = function (e, t, n, r) {
        ...
        t.prototype.registerElement = function (t, n) {
            ...
            ["createdCallback", "attachedCallback", "detachedCallback", "attributeChangedCallback"].forEach(function (e) {
                var t = o[e];
                t && (l[e] = function () {
                    N(this)instanceof r || T(this), t.apply(N(this), arguments)
                })
            });
            var d = {prototype: l};
    ...
    b([window.HTMLBodyElement, window.HTMLDocument || window.Document, window.HTMLHeadElement, window.HTMLHtmlElement], ["appendChild", "compareDocumentPosition", "contains", "getElementsByClassName", "getElementsByTagName", "getElementsByTagNameNS", "insertBefore", "querySelector", "querySelectorAll", "removeChild", "replaceChild"]), b([window.HTMLBodyElement, window.HTMLHeadElement, window.HTMLHtmlElement], y), b([window.HTMLDocument || window.Document], ["adoptNode", "importNode", "contains", "createComment", "createDocumentFragment", "createElement", "createElementNS", "createEvent", "createEventNS", "createRange", "createTextNode", "createTreeWalker", "elementFromPoint", "getElementById", "getElementsByName", "getSelection"]), E(t.prototype, l), E(t.prototype, d), E(t.prototype, h), E(t.prototype, {
        get implementation() {
            var e = j.get(this);
            return e ? e : (e = new a(L(this).implementation), j.set(this, e), e)
        }, get defaultView() {
            return N(L(this).defaultView)
        }
    ...
    var u = {
        strictStyling: !1, registry: {}, shimStyling: function (e, n, r) {
            ...
            return e.replace(t, function (e, t, r, o) {
                if (t = O, r) {
                    for (var i, a = r.split(","), s = [], c = 0, l = a.length; l > c && (i = a[c]); c++)i = i.trim(), s.push(n(t, i, o));
                    return s.join(",")
                }
                return t + o
            })
        ...
        e:for (; (e[u - 1] != f || 0 == u) && !this._isInvalid;) {
            ...
            switch (l) {
                ...
                case"scheme":
                    ...
                    break;
                case"scheme data":
                    "?" == y ? (query = "?", l = "query") : "#" == y ? (this._fragment = "#", l = "fragment") : f != y && "	" != y && "\n" != y && "\r" != y && (this._schemeData += o(y));
                    break;
                case"no scheme":
                    if (s && t(s._scheme)) {
                        l = "relative";
                ...
                case"relative":
                    ...
                    if ("/" == y || "\\" == y)"\\" == y && c("\\ is an invalid code point."), l = "relative slash"; else if ("?" == y)this._host = s._host, this._port = s._port, this._path = s._path.slice(), this._query = "?", l = "query"; else {
                        if ("#" != y) {
                            var E = e[u + 1], _ = e[u + 2];
                            ("file" != this._scheme || !m.test(y) || ":" != E && "|" != E || f != _ && "/" != _ && "\\" != _ && "?" != _ && "#" != _) && (this._host = s._host, this._port = s._port, this._path = s._path.slice(), this._path.pop()), l = "relative path";
                            continue
                        }
    ...
    function i(e, t) {
        ...
        if (l)for (var p, h = 0; l > h && (p = s[h]); h++)a(p) ? (c++, n()) : (p.addEventListener("load", r), p.addEventListener("error", i)); else n()
    }
    ...
    var a = e.path, s = e.rootDocument, c = e.flags, l = e.isIE, u = e.IMPORT_LINK_TYPE, d = "link[rel=" + u + "]", p = {
        ...
        parseImport: function (e) {
            if (HTMLImports.__importsParsingHook && HTMLImports.__importsParsingHook(e), e["import"] && (e["import"].__importParsed = !0), this.markParsingComplete(e), e.dispatchEvent(e.__resource && !e.__error ? new CustomEvent("load", {bubbles: !1}) : new CustomEvent("error", {bubbles: !1})), e.__pending)for (var t; e.__pending.length;)t = e.__pending.shift(), t && t({target: e});
            this.parseNext()
        },
...
}(HTMLImports), window.CustomElements = window.CustomElements || {flags: {}}, function (e) {
    ...
    e.addModule = r, e.initializeModules = o, e.hasNative = Boolean(document.registerElement), e.useNative = !t.register && e.hasNative && !window.ShadowDOMPolyfill && (!window.HTMLImports || HTMLImports.useNative)
    ...
    var a = window.HTMLImports ? HTMLImports.IMPORT_LINK_TYPE : "none";
    ...
    function c(e) {
        e.__upgraded__ && (e.attachedCallback || e.detachedCallback) && !e.__attached && p(e) && (e.__attached = !0, e.attachedCallback && e.attachedCallback())
    }
    ...
    function d(e) {
        e.__upgraded__ && (e.attachedCallback || e.detachedCallback) && e.__attached && !p(e) && (e.__attached = !1, e.detachedCallback && e.detachedCallback())
    }
    ...
    function v(e) {
        e = wrap(e), b.dom && console.group("upgradeDocument: ", e.baseURI.split("/").pop()), t(e), w(e), b.dom && console.groupEnd()
    }
    ...
    var b = e.flags, y = e.forSubtree, E = e.forDocumentTree, _ = !window.MutationObserver || window.MutationObserver === window.JsMutationObserver;
    e.hasPolyfillMutations = _;
    var S = !1, T = [], M = Array.prototype.forEach.call.bind(Array.prototype.forEach), O = Element.prototype.createShadowRoot;
    O && (Element.prototype.createShadowRoot = function () {
        var e = O.call(this);
        return CustomElements.watchShadow(this), e
    }), e.watchShadow = h, e.upgradeDocumentTree = g, e.upgradeSubtree = r, e.upgradeAll = t, e.attachedNode = o, e.takeRecords = m
}), CustomElements.addModule(function (e) {
    function t(t) {
    ...
    function t(t, r) {
        ...
        return c.prototype || (c.prototype = Object.create(HTMLElement.prototype)), c.__name = t.toLowerCase(), c.lifecycle = c.lifecycle || {}, c.ancestry = i(c["extends"]), a(c), s(c), n(c.prototype), u(c.__name, c), c.ctor = d(c), c.ctor.prototype = c.prototype, c.prototype.constructor = c.ctor, e.ready && v(document), c.ctor
    }
    ...
    function h(e, t) {
        ...
        var r;
        return t ? (r = h(e), r.setAttribute("is", t), r) : (r = M(e), e.indexOf("-") >= 0 && y(r, HTMLElement), r)
    }
    ...
    var m, w = e.isIE11OrOlder, v = e.upgradeDocumentTree, g = e.upgradeAll, b = e.upgradeWithDefinition, y = e.implementPrototype, E = e.useNative, _ = ["annotation-xml", "color-profile", "font-face", "font-face-src", "font-face-uri", "font-face-format", "font-face-name", "missing-glyph"], S = {}, T = "http://www.w3.org/1999/xhtml", M = document.createElement.bind(document), O = document.createElementNS.bind(document);
    m = Object.__proto__ || E ? function (e, t) {
        ...
        return !1
    }, f(Node.prototype, "cloneNode"), f(document, "importNode"), w && !function () {
    ...
    }(), document.registerElement = t, document.createElement = h, document.createElementNS = p, e.registry = S, e["instanceof"] = m, e.reservedTagList = _, e.getRegisteredDefinition = l, document.register = document.registerElement
}), function (e) {
    function t() {
        a(wrap(document)), window.HTMLImports && (HTMLImports.__importsParsingHook = function (e) {
            a(wrap(e["import"]))
        }), CustomElements.ready = !0, setTimeout(function () {
            CustomElements.readyTime = Date.now(), window.HTMLImports && (CustomElements.elapsed = CustomElements.readyTime - HTMLImports.readyTime), document.dispatchEvent(new CustomEvent("WebComponentsReady", {bubbles: !0}))
        })
    }
    ...
    if (window.wrap || (window.ShadowDOMPolyfill ? (window.wrap = ShadowDOMPolyfill.wrapIfNeeded, window.unwrap = ShadowDOMPolyfill.unwrapIfNeeded) : window.wrap = window.unwrap = function (e) {
            return e
    ...
    var r = [], o = function (e) {
        "string" != typeof e && 1 === arguments.length && Array.prototype.push.call(arguments, document._currentScript), r.push(arguments)
    };
